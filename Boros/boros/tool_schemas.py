...
TOOL_SCHEMAS = {
    ...
    "evolve_propose": _s("evolve_propose", "Create a formal evolution proposal with snapshot.", {"description": {"type": "string", "description": "What the proposed change does"}, "target_file": {"type": "string", "description": "File path being modified"}, "diff_summary": {"type": "string", "description": "Summary of the code changes"}}, ["description", "target_file"]),
